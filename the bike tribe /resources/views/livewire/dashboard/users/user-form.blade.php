                  ...
                  <div class="p-7">
                      ...
                      <div class="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                        <div class="w-full sm:w-1/2">
                          ...
                          <div class="relative">
                            ...
                            <input
                              ...
                              id="name" name="name" type="text" wire:model="name"   required autofocus autocomplete="name"   />
                        ...
                        <div class="w-full sm:w-1/2">
                          ...
                          <input
                           ...
                           id="mobile_no" wire:model="mobile_no"   type="text"   required autofocus autocomplete="mobile_no" />
                      ...
                      <div class="mb-5.5">
                        ...
                        <div class="relative">
                          ...
                          <input
                            class="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                            type="email" wire:model="email"  placeholder="yourname@gmail.com"
                               />
