<header class="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
  <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
    <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
      ...
      <!-- Hamburger Toggle BTN -->
      <div style="background-color: #ff000;">
      <a class="block flex-shrink-0 lg:hidden" href="{{route('dashboard')}}">
        <img src="{{asset('frontend/img/general/logo-dark.png')}}" alt="" />
      </a>
    </div>
    </div>
    <div class="hidden sm:block">
      <form action="https://formbold.com/s/unique_form_id" class="hidden" method="POST">
        <div class="relative">
            ...
            <ul class="flex h-auto flex-col overflow-y-auto">
              <li>
                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                  ...
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{asset('dashboard/images/user/user-02.png')}}" alt="User" />
                  </div>
              ...
              <li>
                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                  href="messages.html">
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{asset('dashboard/images/user/user-01.png')}}" alt="User" />
                  </div>
              ...
              <li>
                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                  href="messages.html">
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{asset('dashboard/images/user/user-03.png')}}" alt="User" />
                  </div>
              ...
              <li>
                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                  href="messages.html">
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{asset('dashboard/images/user/user-04.png')}}" alt="User" />
                  </div>
      ...
      <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
        <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
          <span class="hidden text-right lg:block">
            <span class="block text-sm font-medium text-black dark:text-white text-center">{{ Auth::user()->name }}</span>
            <span class="block text-xs font-medium">{{ Auth::user()->user_id }}</span>
          </span>

          <span class="h-12 w-12 rounded-full">
            <img src="{{asset('dashboard/images/user/user-01.png')}}" alt="{{ Auth::user()->name }}" />
          </span>
        ...
        <div x-show="dropdownOpen"
          ...
          <ul class="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
            ...
            <li>
              <a href="{{route('profile.edit')}}?action=password"
                class="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
                <svg class="fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g opacity="1">
          ...
          <button
            class="flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base" onclick="logOutform.submit();">
            <svg class="fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
