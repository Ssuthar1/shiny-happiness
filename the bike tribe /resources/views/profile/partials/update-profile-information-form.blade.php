                      ...
                      <div class="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                        <div class="w-full sm:w-1/2">
                          ...
                          <div class="relative">
                            ...
                            <input
                              ...
                              id="name" name="name" type="text" value="{{$user->name}}" required autofocus autocomplete="name"   />
                        ...
                        <div class="w-full sm:w-1/2">
                          ...
                          <input
                           ...
                           id="mobile_no" name="mobile_no" type="text" value="{{$user->mobile_no}}" required autofocus autocomplete="mobile_no" />
                        </div>
                      </div>
                      ...
                      <div class="mb-5.5">
                        ...
                        <div class="relative">
                          ...
                          <input
                            ...
                            value="{{$user->email}}" disable readonly />
                        </div>
                      </div> 
