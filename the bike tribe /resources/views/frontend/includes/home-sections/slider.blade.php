              ...
              <div class="col-auto">
                <div class="masthead__content">
                  <div class="masthead__bg">
                    <img src="{{asset('frontend/')}}/img/masthead/7/bg.png" alt="image">
                  </div>
        ...
        <div class="button-grid items-center">
                  ...
                  <div>
                    <button class="-link d-block col-12 text-left rounded-4 px-20 py-15 js-search-option">
                      <div class="d-flex">
                        ...
                        <div class="ml-10">
                          <div class="text-15 lh-12 fw-500 js-search-option-target">Delhi</div>
                  ...
                  <div>
                    <button class="-link d-block col-12 text-left rounded-4 px-20 py-15 js-search-option">
                      <div class="d-flex">
                        <div class="icon-location-2 text-light-1 text-20 pt-4"></div>
                        <div class="ml-10">
                          <div class="text-15 lh-12 fw-500 js-search-option-target">Agra</div>
          ...
          <div class="searchMenu-date px-30 lg:py-20 lg:px-0 js-form-dd js-calendar">
            ...
            <div data-x-dd-click="searchMenu-date">
              <h4 class="text-15 fw-500 ls-2 lh-16">When?</h4>
