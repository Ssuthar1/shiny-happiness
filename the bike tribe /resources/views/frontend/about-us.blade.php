 <x-front-app-layout>   
    ...
    <section class="section-bg layout-pt-lg layout-pb-lg">
      <div class="section-bg__item col-12">
        <img src="{{asset('frontend/')}}/img/pages/about/1.png" alt="image">
      </div>
    ...
    <section class="layout-pt-md">
      <div class="container">
        <div class="row y-gap-30 justify-between items-center">
          <div class="col-lg-5">
            <h2 class="text-30 fw-600">About The Bike Tribe</h2>
          ...
          <div class="col-lg-6">
            <img src="{{asset('frontend/')}}/img/pages/about/2.png" alt="image" class="rounded-4">
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="overflow-hidden pt-40 js-section-slider" data-gap="30" data-slider-cols="xl-5 lg-4 md-2 sm-2 base-1" data-nav-prev="js-team-prev" data-pagination="js-team-pag" data-nav-next="js-team-next">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="{{asset('frontend/')}}/img/team/1.png" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="{{asset('frontend/')}}/img/team/2.png" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="{{asset('frontend/')}}/img/team/3.png" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="{{asset('frontend/')}}/img/team/4.png" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="{{asset('frontend/')}}/img/team/5.png" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="{{asset('frontend/')}}/img/team/6.png" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="{{asset('frontend/')}}/img/team/7.png" alt="image" class="rounded-4 col-12">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonials -type-1 bg-white rounded-4 pt-40 pb-30 px-40">
                <h4 class="text-16 fw-500 text-blue-1 mb-20">The Bike Tribe</h4>
                ...
                <div class="pt-20 mt-28 border-top-light">
                  <div class="row x-gap-20 y-gap-20 items-center">
                    <div class="col-auto">
                      <img class="size-60" src="{{asset('frontend/')}}/img/avatars/1.png" alt="image">
                    </div>
