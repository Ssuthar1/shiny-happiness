                  ...
                  <div class="p-7">
                      ...
                      <div class="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                        <div class="w-full sm:w-1/2">
                          ...
                          <div class="relative">
                            ...
                            <input
                              ...
                              id="name" name="name" type="text" wire:model.defer="name"   required autofocus autocomplete="name"   />
                        ...
                        <div class="w-full sm:w-1/2">
                          ...
                          <input
                           ...
                           id="mobile_no" wire:model.defer="mobile_no"   type="text"   required autofocus autocomplete="mobile_no" />
                      ...
                      <div class="mb-5.5">
                        ...
                        <div class="relative">
                          ...
                          <input
                            class="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                            type="email" wire:model.defer="email"  placeholder="yourname@gmail.com"
                               />
                      ...
                      <div class="flex justify-end gap-4.5">
                        <button
                          ...
                          type="button" wire:click="resetUser()">
                          Cancel
                        </button>
                        <button
                          class="flex justify-center rounded bg-primary py-2 px-6 font-medium text-gray hover:bg-opacity-90"
                          type="button" wire:click="storeUser()">
                          Create {{$userrole}}
                        </button>
                      </div>
