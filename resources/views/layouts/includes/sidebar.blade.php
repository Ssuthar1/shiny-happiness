...
>
  ...
  <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
    <a href="{{route('dashboard')}}">
      <img src="{{asset('dashboard/images/logo/logo.jpg')}}" class="w-30" alt="Logo" />
    </a>
    ...
    >
      ...
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li> 
            <a
              class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 @if(isset($module) && $module=='bookingList')  bg-graydark dark:bg-meta-4 @endif"
              href="{{route('dashboard.bookingList')}}" 
            >
          ...
          <li> 
            <a
              class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 @if(isset($module) && $module=='paymentInformation')  bg-graydark dark:bg-meta-4 @endif"
              href="{{route('dashboard.paymentInformation')}}" 
            >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
